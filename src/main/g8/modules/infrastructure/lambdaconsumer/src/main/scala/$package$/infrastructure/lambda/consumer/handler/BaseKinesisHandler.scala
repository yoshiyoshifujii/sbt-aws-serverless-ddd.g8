package $package$.infrastructure.lambda.consumer.handler

import $package$.infrastructure.lambda.consumer.model.KinesisEvent._
import $package$.infrastructure.lambda.consumer.model.{KinesisFailure, RetryKinesisFailure, SkipKinesisFailure}
